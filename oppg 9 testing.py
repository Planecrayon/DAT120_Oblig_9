...
class Question:
    ...
    def korrekt_svar_tekst(self):
        print(f'\nRett svar er: {self.alt[self.correct]} \n') # returnerar rett svar
...
if __name__ == "__main__":
    ...
    for i in les_fil():
        ...
        inn_1 = int(input('Svar frå spiller 1: '))-1 # tek inn svar frå spiller 1
        inn_2 = int(input('Svar frå spiller 2: '))-1 # tek inn svar frå spiller 2


        correct_1 = i.sjekk_svar(inn_1) # sendar svar frå spiller 1 til def sjekk_svar
        correct_2 = i.sjekk_svar(inn_2) # sendar svar frå spiller 2 til def sjekk_svar

        print('\nSpiller 1: '+ ('Riktig svar!' if correct_1 else 'Feil svar')) #printar ut om svaret var rett eller feil, dersom correct_1 er True blir if utførst og 'Riktig svar' printa
        if correct_1 == True:
            poeng_1 += 1
    ...
    print(f'Spiller 1 fikk {poeng_1} poeng, og spiller 2 fikk {poeng_2} poeng.\n')
